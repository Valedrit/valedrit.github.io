...
{% set title = 'Đăng nhập vào cộng đồng | BlogBB' %}
{% if signin %}
...
<p>Tài khoản:</p>
<input type="text" name="user" placeholder="Nhập tài khoản" autofocus>
<p>Mật khẩu:</p>
<input type="password"  name="pass" placeholder="Nhập mật khẩu" autofocus>
<p><b style="color:red">*</b> Sử dụng tài khoản BlogBB để đăng nhập !</p>
